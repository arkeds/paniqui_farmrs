...
<body style="background-color: #dadbd6;">
	...
	<main class="container-fluid">
		<a href="{{url('/dashboard')}}" class="btn btn-outline-primary"><i class="fa fa-tachometer-alt"></i> Dashboard</a>
		&nbsp;&nbsp;&nbsp;
		<a href="{{url('/reports')}}" class="btn btn-outline-primary"><i class="fa fa-chart-bar"></i> Reports</a>
		<br><br>
		<div class="row">
